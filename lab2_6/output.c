...
output_results(Simulation_Run_Ptr simulation_run)
{
  ...
  printf("Overal Mean Delay (msec) = %.2f \n",
  ...
  printf("Voice Stream 1 Packet Mean Delay (msec) = %.2f \n",
	  1e3*data->voice_packet_accumulated_delay/data->number_of_voice_packets_processed);

  printf("Voice Stream 2 Packet Mean Delay (msec) = %.2f \n",
	  1e3*data->voice_2_packet_accumulated_delay/data->number_of_voice_2_packets_processed);
