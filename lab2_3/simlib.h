...
typedef struct _event_type_
{
  const char *event_description;
  void (*event_function)(struct _simulation_run_*, void*);
} Event_Type, *Event_Type_Ptr;

typedef struct _event_
{
  struct _event_ *next_event;
  struct _event_ *previous_event;
  struct _event_type_ event_type;
...
{
  struct _event_ *front_ptr;
  struct _event_ *back_ptr;
  int size;
...
long int
simulation_run_schedule_event(Simulation_Run_Ptr, Event_Type, double, void*);
