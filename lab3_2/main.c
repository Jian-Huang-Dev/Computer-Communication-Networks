...
/*******************************************************************************/
int NUMBER_OF_CHANNELS = 1, Call_ARRIVALRATE = 1;
...
int main(void)
{
	...
	while (NUMBER_OF_CHANNELS <= 19) {
		while (Call_ARRIVALRATE <= 10) {
		...
		Call_ARRIVALRATE++;
		}// Call_ARRIVALRATE while loop
		NUMBER_OF_CHANNELS++;
		Call_ARRIVALRATE = 1; // reset offered load to 1, hence to re-looping
}// NUMBER OF CHANNELS while loop
